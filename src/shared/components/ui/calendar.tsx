  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(buttonVariants({ variant: "ghost" }), "h-9 w-9 p-0 font-normal aria-selected:opacity-100 hover:bg-muted hover:text-muted-foreground transition-colors"),
        day_range_end: "day-range-end",
        day_selected:
          "bg-white text-[#1e293b] hover:bg-white hover:text-[#1e293b] focus:bg-white focus:text-[#1e293b] rounded-md",
        day_today: "text-foreground",
        day_outside:
          "day-outside text-muted-foreground opacity-50 aria-selected:bg-accent/50 aria-selected:text-muted-foreground aria-selected:opacity-30",
        day_disabled: "text-muted-foreground opacity-50",
        day_range_middle: "aria-selected:bg-white/20 aria-selected:text-white hover:bg-muted",
