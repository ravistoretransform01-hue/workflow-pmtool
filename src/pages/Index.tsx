...
const Index = () => {
  return (
    <div className="min-h-screen w-full bg-gradient-dark">
      {/* Hero Section */}
      <div className="container mx-auto px-4 py-16 flex flex-col items-center justify-center min-h-screen text-center animate-fade-in">
        ...
        <p className="text-xl md:text-2xl text-muted-foreground mb-12 max-w-2xl animate-slide-up" style={{ animationDelay: "0.2s" }}>
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-16 animate-slide-up" style={{ animationDelay: "0.3s" }}>
          <Link to="/signup">
            <Button size="lg" className="h-14 px-8 text-lg font-medium shadow-elegant">
              Get Started
              <ArrowRight className="ml-2 h-5 w-5" />
            </Button>
          </Link>
          <Link to="/login">
            <Button size="lg" variant="outline" className="h-14 px-8 text-lg font-medium border-2 border-border hover:bg-card/50">
              Sign In
            </Button>
          </Link>
        </div>
        ...
        {/* Features Grid */}
        <div className="grid md:grid-cols-3 gap-6 w-full max-w-5xl animate-slide-up" style={{ animationDelay: "0.4s" }}>
